<div class="relative group">
    ...
    <div class="absolute bottom-0 left-0 w-full mt-2 w-48 rounded-lg shadow-lg bg-white dark:bg-slate-700 hidden group-hover:block z-10">
        ...
        <nav class="py-1">
            ...
            <a href="{{ route('profile.edit') }}" wire:navigate class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-600 flex items-center gap-2">
